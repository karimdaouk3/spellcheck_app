        ...
        feedbackBtns.forEach(btn => {
            btn.addEventListener('click', (e) => {
                ...
                if (!feedbackBox) {
                    ...
                    feedbackBox.innerHTML = `<textarea class="llm-feedback-text" rows="1" placeholder="Please explain why you disagree with this evaluation."></textarea><button class="llm-feedback-submit" title="Send Feedback"> <svg width='20' height='20' viewBox='0 0 24 24' fill='none' stroke='currentColor' stroke-width='2' stroke-linecap='round' stroke-linejoin='round'><line x1='22' y1='2' x2='11' y2='13'/><polygon points='22 2 15 22 11 13 2 9 22 2'/></svg></button>`;
