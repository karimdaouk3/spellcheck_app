class LanguageToolEditor {
    ...
    showStatus(message, type = 'success', persist = false, removeLoading = false) {
        ...
        let icon = '';
        if (type === 'recording') {
            icon = '<span style="display:inline-flex;align-items:center;margin-right:8px;"><svg width="18" height="18" viewBox="0 0 18 18"><circle cx="9" cy="9" r="8" fill="none" stroke="#fff" stroke-width="3"/><circle cx="9" cy="9" r="4" fill="#d32f2f"/></svg></span>';
        }
