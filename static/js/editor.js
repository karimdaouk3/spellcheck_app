class LanguageToolEditor {
    ...
    showStatus(message, type = 'success', persist = false, removeLoading = false) {
        ...
        let icon = '';
        if (type === 'recording') {
            icon = '<span style="display:inline-flex;align-items:center;margin-right:8px;"><svg width="16" height="16" viewBox="0 0 16 16"><circle cx="8" cy="8" r="7" fill="none" stroke="#fff" stroke-width="2"/><circle cx="8" cy="8" r="3.5" fill="#d32f2f"/></svg></span>';
        }
