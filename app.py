...
def check_external_crm_exists(case_number):
    ...
    try:
        ...
        print(f"🔍 [CRM] Query parameters: case_number_str='{case_number_str}' (email restriction disabled for testing)")
...
def check_external_crm_status_for_case(case_id):
    ...
    try:
        ...
        # SIMULATION: Force case 502771540 to be closed for testing
        if str(case_id) == '502771540':
